...
<html>
    ...
    <body>
        ...
        <%
           ArrayList<EtatStock> allstocks=(ArrayList<EtatStock>)request.getAttribute("stocks");
      ...
      <li class="nav-item">
        ...
        <div class="card-body">
            ...
            <!-- Table with stripped rows -->
              ...
              <% for(EtatStock stocks: allstocks) { %>              
              <tbody>
          ...
          <h5 class="card-title">Un total <%= request.getAttribute("total") %> Ar</h5>
