...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Sortiestock.jsp">
          <i class="bi bi-grid"></i>
    ...
    <div class="login-title">
        <h4 class="title">Faire une sortie de stock</h4>
        <div id="loginbox" class="loginbox">
              <form action="SortieServlet" method="get">
                <p>
                ...
                <p>
                  <label for="modlgn_passwd">Date de sortie</label>
